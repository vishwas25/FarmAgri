...
<div class="col-sm-8" style="padding:15px;">
      <label for="inputEmail4">Fertilizer Name :</label>
      <input type="age" name="good" class="form-control" id="inputnumber" placeholder="Fertilizer Name" required>
</div>
<div class="col-sm-2" style="padding:15px;">
</div>
...
$filename = $file['name'];
      ...
      if($fileerror == 0){
        $destfile = 'fertilizer/'.$filename;
        move_uploaded_file($filepath, $destfile);
      
$insertquery ="insert into fertilizer(fetid,fname,description,price,image,status) 
values('$rand','$name','$description','$price','$destfile','Avaliable')";
