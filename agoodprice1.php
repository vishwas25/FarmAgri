...
<?php
    ...
    if(isset($_GET['gid'])){
    $gid = $_GET['gid'];
    $selectquery = "select * from goodprice where gid='$gid'";
    ...
    <h1 style="font-family:Serif;color:black;text-align:center;font-size:30px"><?php echo $result['name'];?>.</h1>
    ...
    $updatequery = "update goodprice set  price='$price' where gid='$gid' ";    
