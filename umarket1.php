...
if(isset($_GET['id'])){
    $resid = $_GET['id'];
  $selectquery = "select signup.name,signup.city,sell.product,sell.epu,sell.quantity,sell.date,sell.goodid,sell.time,sell.description,sell.age,sell.image,sell.Lid from sell inner join signup on signup.loginid=sell.Lid where goodid ='$resid'";
...
<a href="umarket.php" class="btn btn-outline-success"><i class="fa fa-arrow-left" aria-hidden="true"></i></a><br><br>
</div>
<div class="col-sm-10" style="padding:5px;"><br>
<p  style="font-family:Serif;color:black;text-align:center;font-size:20px">Farmer : <?php echo $result['name'];?>.</p>
<p  style="font-family:Serif;color:black;text-align:center;font-size:15px">Date : <?php echo $result['date'];?> & Time : <?php echo $result['time'];?>.</p>
...
<div class="col-sm-2" style="padding:15px;">
<p style="font-family:Serif;color:gray;text-align:left;font-size:18px">Age : </p>
<p style="font-family:Serif;color:gray;text-align:left;font-size:18px">Location : </p>
<p style="font-family:Serif;color:gray;text-align:left;font-size:18px">Quantity : </p>
<p style="font-family:Serif;color:gray;text-align:left;font-size:25px">Price : </p>
</div>
<div class="col-sm-6" style="padding:15px;">
<p style="font-family:Serif;color:black;text-align:right;font-size:18px"><?php echo $result['age'];?> Days</p>
<p style="font-family:Serif;color:black;text-align:right;font-size:18px"><?php echo $result['city'];?></p>
<p style="font-family:Serif;color:black;text-align:right;font-size:18px"><?php echo $result['quantity'];?> Quintal</p>
<p style="font-family:Serif;color:black;text-align:right;font-size:25px"><?php echo $result['epu'];?> Rs. </p>
</div>
<div class="col-sm-2" style="padding:15px;">
</div>
</div>
...
<div class="col-sm-1">
<button class="flex btn btn-outline-primary" onclick="openForm3()">Interested</button>
</div></div>
...
<div class="form-popup3" id="myForm3">
          <form action="" class="form-container3" method="post">
          <h1><s></s></h1>

          <label for="regid"><b>Your Offering Price :</b></label>
          <input type="text" placeholder="Your Price" name="price" required>   
          <button type="submit" name="submit" class="btn">Show Interest</button>
