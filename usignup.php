...
<div class="form-group col-sm-3">
      <label for="inputEmail4">You Are :</label>
      <select name="id" id="country" class="form-control" required>
...
if($id=='Farmer'){
    $rand = "FM". rand(1000000,9999999);
}else{
    $rand = "IN".rand(1000000,9999999);
}
...
if($emalcount>0)
{
  ...
  {
$insertquery ="insert into signup(loginid,name,mobile,email,password,cpassword,address,city,state,pincode,date,time,image,proof,status,mstatus,token,otp) 
